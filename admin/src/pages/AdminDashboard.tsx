            ...
            <CardContent>
              <div className="grid gap-6 lg:grid-cols-[1fr,2fr]">
                <div className="custom-scrollbar max-h-[600px] space-y-3 overflow-y-auto pr-2">
                  {(clientsQuery.data as Tenant[] | undefined)?.map(
                    (client) => (
                      <div
                        key={client._id}
                  ...
                  {(clientsQuery.data as Tenant[] | undefined)?.length ===
                    0 && (
                    ...
                    <form onSubmit={handleClientUpdate}>
                      <div className="space-y-6 p-6">
                        ...
                        <div>
                          ...
                          <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="edit-biz-address">
                                Business Address
                              </Label>
                              <Input
                                id="edit-biz-address"
                      ...
                      <div className="mt-4 flex flex-wrap items-center justify-between gap-4 border-t bg-muted/50 p-6">
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            refreshKeyMutation.mutate(selectedClient._id)
                          }
        ...
        <TabsContent value="templates" className="mt-0">
          <Card className="border-none bg-gradient-to-br from-card to-muted/20 shadow-xl">
            <CardHeader>
              ...
              <CardDescription>
                Seed or manage template definitions used during client
                onboarding.
              </CardDescription>
            </CardHeader>
            <CardContent>
