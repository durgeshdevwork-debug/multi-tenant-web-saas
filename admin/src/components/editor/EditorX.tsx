...
import { CHECK_LIST, ELEMENT_TRANSFORMERS, MULTILINE_ELEMENT_TRANSFORMERS, TEXT_FORMAT_TRANSFORMERS, TEXT_MATCH_TRANSFORMERS, $convertFromMarkdownString, $convertToMarkdownString } from "@lexical/markdown";
  ...
  useEffect(() => {
    editor.update(() => {
      ...
      if (typeof value === "string") {
        if (value.startsWith("{") && value.includes('"root"')) {
          try {
...
export function EditorX({
  ...
  onLexicalChange?: (editorState: EditorState) => void;
  ...
  const AppExtension = useMemo(
    ...
    [editorState, editorSerializedState, value],
  );
        ...
        <TooltipProvider>
          <div className="relative">
            ...
            <div className="relative">
              ...
              <TwitterPlugin />
              <YouTubePlugin />
              <DraggableBlockPlugin anchorElem={floatingAnchorElem} baseOptions={componentPickerOptions} />
